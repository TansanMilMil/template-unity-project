...
namespace TansanMilMil.Util
{
    ...
    {
        public static IList<ParsedKeyValue<TKey, TValue>> ParseAsList(IDictionary<TKey, TValue> dic)
        {
        ...
        public static IDictionary<TKey, TValue> ParseAsDictionary(IEnumerable<ParsedKeyValue<TKey, TValue>> list)
        {
